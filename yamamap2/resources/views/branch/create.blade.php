...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <h5 class="card-header">حساب فرع جديد </h5>
                <div class="card-body">



                    <form method="POST" action="{{ route('branch.store') }}" id="formValidationExamples" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="formValidationName" class="form-control" name="name"
                            ...
                            <select class="form-control" name="price_categori" id="price_categori">
                                ...
                                @if (@isset($price_categorie_name) && !@empty($price_categorie_name))
                                    @foreach ($price_categorie_name as $info)
                                        <option @if (old('price_categori') == $info->id) selected="selected" @endif
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="boxTl">رصيد اول المدة بالليرة  </label>
                            <input type="number" id="boxTl" class="form-control" min="0"
                                name="boxTl" value='0'>

                        </div>

                        <div class="col-md-6">
                          <label class="form-label" for="boxUsd">رصيد اول المدة بالدولار  </label>
                            <input type="number" id="boxUsd" class="form-control" min="0"
                                name="boxUsd" value='0'>
