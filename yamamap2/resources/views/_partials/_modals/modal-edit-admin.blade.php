    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="editUserForm" method="POST" action="{{ route('adminPanelSetting.update', $data['id']) }}"
                    class="row g-3">
                    ...
                    {{-- <div class="row mt-2">
                        <label class="col-sm-3 col-form-label" for="multicol-country"> صور البروفايل</label>
