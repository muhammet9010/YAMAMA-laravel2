...
@section('content')
    ...
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">بيانات حساب /</span> المدينين
    </h4>
    <a href="{{ route('debtors.export_pdf') }}" class="mb-4 btn btn-success waves-effect waves-light">PDF</a>
    <a href="{{ route('debtors.export_excel') }}" class="mb-4 btn btn-success waves-effect waves-light">Excel</a>
                    ...
                    <table class="table key-buttons text-md-nowrap" id="example2">
                        ...
                        <thead class="custom_thead table-dark">
                            <tr class="">
                                ...
                                <th class="text-center">اسم المدين </th>
